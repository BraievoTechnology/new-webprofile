...
export const LinkedInIcon: React.FC<{ className?: string }> = ({ className }) => (
  ...
  >
    <path d="M20.5 2h-17A1.5 1.5 0 002 3.5v17A1.5 1.5 0 003.5 22h17a1.5 1.5 0 001.5-1.5v-17A1.5 1.5 0 0020.5 2zM8 19H5v-9h3zM6.5 8.25A1.75 1.75 0 118.25 6.5 1.75 1.75 0 016.5 8.25zM19 19h-3v-4.74c0-1.42-.6-2.16-1.92-2.16-1.12 0-1.58.77-1.83 1.52-.09.27-.11.64-.11 1.01V19h-3v-9h2.9v1.3a3.11 3.11 0 012.7-1.4c1.55 0 3.33 1.03 3.33 4.26V19z"></path>
  </svg>
);
